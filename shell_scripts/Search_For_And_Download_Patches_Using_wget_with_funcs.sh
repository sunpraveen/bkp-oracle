...
# *==================================================================================+
# |
# | FILENAME    : Search_For_And_Download_Patches_Using_wget_with_funcs.sh
# | DESCRIPTION : Given a patch number, search for it in MOS and download it.
# | USAGE       : Search_For_And_Download_Patches_Using_wget_with_funcs.sh -p <patch_number> OR
# |               Search_For_And_Download_Patches_Using_wget_with_funcs.sh --patch <patch_number>
# | AUTHOR      : Praveen B K
# |
# +==================================================================================+
## Variables
